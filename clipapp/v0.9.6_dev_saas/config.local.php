...
if( $configName == 'kmc' ) {
	...
	$config['kmc'] = array(
		...
		'show_embed' => false,
		'trim_save_message' => 'The trimmed video is now converting. This might take a few mintues. Please close the window to continue.',
		'clip_save_message' => 'A new entry has been created. You can close this window to view the new clip in the entries table or create another clip.',
	);
